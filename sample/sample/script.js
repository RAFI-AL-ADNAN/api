...
searchForm.addEventListener("click", () => {
  ...
  fetch(finalURL)
      ...
      .then((data) => {
          ...
          resultContainer.innerHTML = basicInfo;
          resultContainer.appendChild(moreDetailsButton);

          // Additional details section
          let additionalDetails = document.createElement('div');
          additionalDetails.className = 'additional-details';
          additionalDetails.style.display = 'none'; // Hide initially

          // Add additional details to the container
          // Modify this section to include more detailed information as needed
          ...
          resultContainer.appendChild(additionalDetails);
      })
      .catch(() => {
